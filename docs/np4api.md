...
This directory contains samples and a core utility for interacting with the Neptune's Pride 4 official API.

## Key Features
- **API Client**: A simple `get` function that handles fetch requests to the NP4 API endpoint.
